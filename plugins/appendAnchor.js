...
(function(){
  ...
  if (stringToBoolean(options.auto_append_anchor, false)) {
    let originalHintsShow = dactyl.modules.hints.show;
    let once = stringToBoolean(options.auto_append_anchor_once, false);
    hints.show = function () {
  ...
  // register command
  group.commands.add(['anc'], 'append anchors to texts look like url',
    function(arg) {
